...
real opacity_semenov_malygin(int rosseland, real rho, real T_dust) 
{
  ...
  // log of evaporation temperature T_ev(rho)
  //       water ice        iron             orthopyroxene    olivine
  const static real logtt[8][4] = {
    {2.03742650, 2.92168648, 2.95520654, 2.96801571},
    {2.07188201, 2.95808585, 2.99122608, 2.99869516},
    {2.11058971, 2.99738638, 3.02077549, 3.03181227},
    {2.15533604, 3.04139269, 3.05269394, 3.06744284},
    {2.20139712, 3.08990511, 3.08707121, 3.10619090},
    {2.25527251, 3.14457421, 3.12417806, 3.14860265},
    {2.31597035, 3.20736504, 3.16494737, 3.19589965},
    {2.38738983, 3.28057837, 3.20978301, 3.24895362}
  };
